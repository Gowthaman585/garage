...
But today i get to know about few more new or get more insight about something's like
	Cellular network
	Ports in router
	Little more about cables like co-axial,fibre optics,ethernet cables.
	First time get to know about DSL cables.
Scored 80 percent in the checkpoint with some good satisfaction.but a small regret because of i have not tried the handson activity yet till.
...
This chapter almost 90% already well covered by me in college,by the sysllabus itself. The college syllabus lesson Networking Principles is were already thought me about almost all the topics.
...
Scenario : One of the PC has misconfigured ip configaration's find out and then sort out.
...
Scenario :The PC can able to ping the DNS ip successfully.also it can reach the default gateway but can't successfully reach the server when i ping with uri
